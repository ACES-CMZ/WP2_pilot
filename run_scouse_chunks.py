...
s1file='s1.15.scousepy'#'s1.combine.scousepy' # You will need to update these accordingly!!
s2file='s2.15.scousepy'#'s2.combine.scousepy' # You will need to update these accordingly!!
