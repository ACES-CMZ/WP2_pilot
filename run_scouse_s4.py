...
s = scouse.stage_3(config=config_file+str('.v0'), s1file=s1file, s2file=s2file, s3file='s3.scousepy.'+tolver)
s = scouse.stage_4(config=config_file+str('.v0'), s1file=s1file, s2file=s2file, s3file='s3.scousepy.'+tolver, s4file='s4.refit.scousepy.'+tolver, bitesize=True)
